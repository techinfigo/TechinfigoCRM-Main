...
export const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  const navItems = [
    ...
    { view: 'AUDITS', label: 'Audits', icon: <FileSearch />, feature: 'marketingAudits', permission: 'canView' },
    { view: 'CALENDAR', label: 'Calendar', icon: <Calendar />, feature: 'calendar', permission: 'canView' },
    { view: 'SOP_LIBRARY', label: 'SOP Library', icon: <BookOpen />, feature: 'sopLibrary', permission: 'canView' },
    { view: 'INTEGRATIONS', label: 'Integrations & Webhooks', icon: <Webhook />, feature: 'integrations', permission: 'canView' },
