            ...
            <div style={{ background: INK, color: '#fff', padding: '28px 40px 24px', flexShrink: 0 }}>
              <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 18 }}>
                {appSettings.agencyLogoUrl
                  ? <img src={appSettings.agencyLogoUrl} alt={agencyName} style={{ height: appSettings.invoiceLogoHeight || 100, maxHeight: appSettings.invoiceLogoHeight || 100, maxWidth: 420, objectFit: 'contain' }} />
