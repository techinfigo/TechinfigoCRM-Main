  ...
  const handleLogoChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      if (!file.type.startsWith('image/')) {
        alert("Invalid file type. Please select an image."); return;
      }
      if (file.size > 500 * 1024) { 
        alert("File is too large. Max 500KB."); return;
      }
      ...
      <div className="space-y-6">
        ...
        <div>
            ...
            <div className="flex items-center gap-4">
                <div className="w-24 h-16 flex items-center justify-center bg-slate-100 dark:bg-slate-700 rounded-md overflow-hidden border border-border-muted dark:border-slate-600">
