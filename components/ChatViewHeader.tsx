                ...
                <div className="relative">
                    ...
                    {showMenu && (
                        <div ref={menuRef} className="absolute right-0 top-full mt-2 z-50 w-48 bg-white dark:bg-zinc-900 rounded-xl shadow-xl border border-gray-100 dark:border-zinc-800 p-1.5 origin-top-right animate-in fade-in zoom-in-95 duration-200 ring-1 ring-black/5">
                            <button className="w-full px-3 py-2 text-left text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-secondary-accent/10 hover:text-secondary-accent dark:hover:bg-secondary-accent/20 dark:hover:text-secondary-accent rounded-lg transition-colors">View Profile</button>
                            <button className="w-full px-3 py-2 text-left text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-secondary-accent/10 hover:text-secondary-accent dark:hover:bg-secondary-accent/20 dark:hover:text-secondary-accent rounded-lg transition-colors">Clear History</button>
