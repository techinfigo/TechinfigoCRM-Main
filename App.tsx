...
export const App: React.FC<AppProps> = ({ onSignOut }) => {
  ...
  useEffect(() => {
      ...
      newRoleDefinitions = [
        {
          ...
          permissions: defaultPermissions.map((p) => ({
            ...p,
            currentPermissions: Object.keys(p.currentPermissions).reduce(
    ...
    if (newTeamMembers.length === 0) {
      const adminRoleId =
        newRoleDefinitions.find((r) => r.name === "Admin")?.id || "role-admin";
      ...
      const secondUser: TeamMember = {
        ...
        role: "Member",
        roleId:
          newRoleDefinitions.find((r) => r.name === "Member")?.id ||
          "role-member",
    ...
    if (clients.length === 0) {
      const demoClients: Client[] = [
        ...
        {
          id: "c-2",
          name: "Bloom Lifestyle",
          companyName: "Bloom Lifestyle Co",
          email: "hello@bloomlife.com",
          phone: "555-0202",
          website: "www.bloomlife.com",
          industry: "Retail",
          dateAdded: new Date().toISOString(),
          healthStatus: "Healthy",
          roi: { current: 45000, goal: 50000 },
          nextAction: {
      ...
      setClients(demoClients, {
        type: "batch",
        description: "Seeded Demo Clients",
        payload: {},
      });
    }
      ...
      const demoLeads: Lead[] = [
        {
          ...
          phone: "555-1010",
          status: "New Lead",
          dateAdded: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(), // Added 2 hours ago (Today)
          ...
          followUpHistory: [
            {
              ...
              addedByUserId: "u-1",
              addedByUserName: "Founder",
              nextFollowUpDateTime: new Date(Date.now() - 24 * 60 * 60 * 1000).toISOString(),
            },
          ],
          emailHistory: [],
          manualCompletionMarkers: {},
        },
        {
          id: "l-3",
          name: "Marcus Wright",
          companyName: "Project Angel",
          email: "marcus@angel.io",
          phone: "555-3333",
          status: "Contacted",
          dateAdded: new Date(Date.now() - 4 * 60 * 60 * 1000).toISOString(), // Added today
          hasDigitalPresence: true,
          source: "Google Ads",
          estimatedBudget: "₹2,00,000 - ₹3,50,000",
          serviceInterest: ["Web Dev", "PPC"],
          followUpHistory: [],
          emailHistory: [],
          manualCompletionMarkers: {},
          nextFollowUpDateTime: new Date(Date.now() + 2 * 60 * 60 * 1000).toISOString(), // Follow-up TODAY (in 2 hours)
        },
        {
          id: "l-4",
          name: "Sarah Connor",
          companyName: "Resistance Fighters",
          email: "sarah@resistance.org",
          phone: "555-9090",
          status: "Audit in Progress",
          dateAdded: new Date(Date.now() - 30 * 60 * 60 * 1000).toISOString(), // Added yesterday
          hasDigitalPresence: true,
          source: "Direct",
          estimatedBudget: "₹4,00,000+",
          serviceInterest: ["SEO", "Security Audit"],
          followUpHistory: [],
          emailHistory: [],
          manualCompletionMarkers: {},
          nextFollowUpDateTime: new Date(Date.now() - 12 * 60 * 60 * 1000).toISOString(), // OVERDUE follow-up (scheduled 12 hours ago)
        },
        {
          id: "l-5",
          name: "Kyle Reese",
          companyName: "Tech-Com Corp",
          email: "kyle@techcom.com",
          phone: "555-0707",
          status: "Proposal Sent",
          dateAdded: new Date(Date.now() - 22 * 60 * 60 * 1000).toISOString(), // Added yesterday
          hasDigitalPresence: false,
          source: "Cold Email",
          estimatedBudget: "₹30,000 - ₹60,500",
    ...
    if (projects.length === 0) {
      const demoProjects: Project[] = [
        ...
        {
          id: "p-2",
          name: "Q3 Social Media",
          projectCode: "SOC-002",
          clientId: "c-2",
          clientName: "Bloom Lifestyle",
          type: "Marketing",
          status: "Backlog",
          priority: "Medium",
          health: "At Risk",
      ...
      setProjects(demoProjects, {
        type: "batch",
        description: "Seeded Demo Projects",
        payload: {},
      });
      ...
      setCampaigns([
        {
          ...
          actualSpend: 12000,
          chartData: {
            spendVsBudget: { budget: 50000, spent: 12000 },
      ...
      setEmails([
        {
          ...
          senderEmail: "john@skynet.com",
          recipientEmail: "founder@agency.com",
          subject: "Project Inquiry",
          body: "Hi, I would like to discuss a new project.",
          timestamp: new Date().toISOString(),
          folder: "inbox",
          isRead: false,
        },
      ...
      setChatContacts([
        {
          ...
          profilePictureUrl:
            "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",
          lastMessage: "Hey, check the new designs!",
      ...
      setChatMessages([
        {
          ...
          contactId: "u-2",
          senderId: "u-2",
          text: "Hey, check the new designs!",
          timestamp: new Date().toISOString(),
          status: "delivered",
        },
      ]);
      ...
      setDailyAttendanceRecords([
        {
          ...
          entries: [
            { memberId: "u-1", status: "Present", checkInTime: "09:00" },
            { memberId: "u-2", status: "Present", checkInTime: "09:15" },
          ],
        },
      ]);
    }
      ...
      const demoSops: SOP[] = [
        {
          ...
          category: "Audit",
          description:
            "How to perform a full D2C audit using our 12-step framework.",
          steps: [
